...
namespace ETicaret.WebUI.TagHelpers
{
    ...
    //Sayfanın en altında oluşan pageable özelliğinin kontrol kısmını oluşturduğumuz class.
    //Birçok sayfada kullandığımız için modül haline getirdik.
    //Böylece her sayfada yazmak zorunda kalmadık.
